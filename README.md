...
6. Jika sudah dibuat, masuk ke menu import lalu import file carikorban.sql dari folder project ini. setelah itu klik go. (jangan lupa ubah akun database di connection.php untuk alasan keamanan)
